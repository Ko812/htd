...
public class EmailUtility {
	...
	public static boolean emailWithPassword(String to, String sc) {
		String from = "ncshtd29@gmail.com";
		...
		Session mailSession = Session.getDefaultInstance(prop, new javax.mail.Authenticator(){
			protected PasswordAuthentication getPasswordAuthentication(){
				PasswordAuthentication pa = new PasswordAuthentication("ncshtd29@gmail.com", "hqaofuzrmxahhfdk");
				return pa;}});
		try {
			...
			bodyPart.setContent("<html><body>" + 
					"Dear user, " 
					+ "<br>" + "<br>" + "<br>" + "<br>"
					+ "You have requested to reset password. Click on the link <br><br><a href=\"http://localhost:8080/job-portal/resetPassword.jsp?sessionCode=" + sc+ "\">http://localhost:8080/job-portal/resetPassword.jsp</a><br><br> to reset your password."
					+ "<br>" + "<br>" + "<br>" + "<br> " 
